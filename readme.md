...
[https://zhuanlan.zhihu.com/p/30044692](https://zhuanlan.zhihu.com/p/30044692)

# Git使用教程,最详细，最傻瓜，最浅显，真正手把手教

[![慕课网](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-d9a1e21976d97ad9b02542a441912121_l.jpg)](https://www.zhihu.com/org/mu-ke-wang-14)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-3bc9d5f2c49a713c776e69676d7d56c5_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-9aeec32780d2e9f79e18d23c5f62c1ce_720w.webp)

需要从网上下载一个，然后进行默认安装即可。安装完成后，在开始菜单里面找到 "Git --> Git Bash",如下：

![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-c2d64e42759f273c3ba357e357f5b3f3_720w.webp)

会弹出一个类似的命令窗口的东西，就说明Git安装成功。如下：

![img](https://pic2.zhimg.com/80/v2-462eece90ab693d5882563e1913d0975_720w.webp)



安装完成后，还需要最后一步设置，在命令行输入如下：

![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-10d948fc6dd26d04f1b4d218c350142f_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-9090108f6e234f5e9084867a26f7acb1_720w.webp)

pwd 命令是用于显示当前的目录。

1. 通过命令 git init 把这个目录变成git可以管理的仓库，如下：

![img](https://pic1.zhimg.com/80/v2-b083c8042d8d79072f2767d72309c7c8_720w.webp)



这时候你当前testgit目录下会多了一个.git的目录，这个目录是Git来跟踪管理版本的，没事千万不要手动乱改这个目录里面的文件，否则，会把git仓库给破坏了。如下：

![img](https://pic2.zhimg.com/80/v2-12dfe594273c59ebf8bfc1f175bc5fc9_720w.webp)
...
![img](https://pic1.zhimg.com/80/v2-e4bb70e38739ec555c19d9febdbb9ba4_720w.webp)

如果和上面一样，没有任何提示，说明已经添加成功了。

第二步：用命令 git commit告诉Git，把文件提交到仓库。

![img](https://pic1.zhimg.com/80/v2-f05b5fe7f65fd2970c92e6381fac7384_720w.webp)

现在我们已经提交了一个readme.txt文件了，我们下面可以通过命令git status来查看是否还有文件未提交，如下：

![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-a879a81b628103b676be5a1e14e037f3_720w.webp)

说明没有任何文件未提交，但是我现在继续来改下readme.txt内容，比如我在下面添加一行2222222222内容，继续使用git status来查看下结果，如下：

![img](https://pic4.zhimg.com/80/v2-6346ea354a8e9b1dc105bd1d0f38273b_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-0a03deaee4bbf855c969ec3c5e561bb2_720w.webp)
...
![img](https://pic1.zhimg.com/80/v2-5a966e86b0b4b181534e819c8aba7d00_720w.webp)
...
![img](https://pic4.zhimg.com/80/v2-2ba6a5f365edb4085e5517ae9cd0774b_720w.webp)

现在我已经对readme.txt文件做了三次修改了，那么我现在想查看下历史记录，如何查呢？我们现在可以使用命令 git log 演示如下所示：

![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-a1ac2eeac5fb8539577344d1e04f25d0_720w.webp)

git log命令显示从最近到最远的显示日志，我们可以看到最近三次提交，最近的一次是,增加内容为333333.上一次是添加内容222222，第一次默认是 111111.如果嫌上面显示的信息太多的话，我们可以使用命令 git log –pretty=oneline 演示如下：

![img](https://pic1.zhimg.com/80/v2-3ad25c769207ede4169452b6724b4324_720w.webp)

现在我想使用版本回退操作，我想把当前的版本回退到上一个版本，要使用什么命令呢？可以使用如下2种命令，第一种是：git reset --hard HEAD^ 那么如果要回退到上上个版本只需把HEAD^ 改成 HEAD^^ 以此类推。那如果要回退到前100个版本的话，使用上面的方法肯定不方便，我们可以使用下面的简便命令操作：git reset --hard HEAD~100 即可。未回退之前的readme.txt内容如下：

![img](https://pic3.zhimg.com/80/v2-a0c4464e051ea6bb5c1bee95ecce8562_720w.webp)

如果想回退到上一个版本的命令如下操作：

![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-99fceb04f605273e3e76cc56621fab03_720w.webp)



再来查看下 readme.txt内容如下：通过命令cat readme.txt查看

![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-fcdc858c36a587a5709c6ccbe987f0f6_720w.webp)



可以看到，内容已经回退到上一个版本了。我们可以继续使用git log 来查看下历史记录信息，如下：

![img](https://pic3.zhimg.com/80/v2-2d96e390ee4627f717f6ac7b5cdce802_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-d5fcbdd6c68e194c470b60cf7e4c8353_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-b8b391807ab7b5726bd017db8f03fd26_720w.webp)
...
![img](https://pic1.zhimg.com/80/v2-a3c3a49b6aad77a98b05428ec1fbd8e8_720w.webp)



现在我们先使用git add 命令把2个文件都添加到暂存区中，再使用git status来查看下状态，如下：

![img](https://pic4.zhimg.com/80/v2-a287f878c94f8619c4b4b9629cc41abf_720w.webp)



接着我们可以使用git commit一次性提交到分支上，如下：

![img](https://pic3.zhimg.com/80/v2-b4fe9c409c49d2f4951cbb2d5cab28a2_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-80689a1d2875a04d8d01a707225d1729_720w.webp)
...
![img](https://pic4.zhimg.com/80/v2-b07807ff2252875a81735045ca5e023b_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-4197261598de42b7cc9d4eaf930b0e9b_720w.webp)
...
![img](https://pic3.zhimg.com/80/v2-782f824577298daf664532c6f819ba12_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-a3160769ebe554f2fa08fb2c1f229569_720w.webp)



如上：一般情况下，可以直接在文件目录中把文件删了，或者使用如上rm命令：rm b.txt ，如果我想彻底从版本库中删掉了此文件的话，可以再执行commit命令 提交掉，现在目录是这样的，

![img](https://pic2.zhimg.com/80/v2-7e8fd8e3bcfadd18576b5d17c62d6c6d_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-368ec1a5c3f42a2765709b62ac0cb16f_720w.webp)



再来看看我们testgit目录，添加了3个文件了。如下所示：

![img](https://pic3.zhimg.com/80/v2-30892a36404bbba35064e3f6f92b6efa_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-c7546a7705a83f46bd82c7b44ac38f55_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-b5ea16049c9c69ff9fce3ed841605407_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-c15608fa9da55a2310476f6482a66341_720w.webp)
...
![img](https://pic3.zhimg.com/80/v2-b5b7516185030d5489c87870d93f8946_720w.webp)



现在dev分支工作已完成，现在我们切换到主分支master上，继续查看readme.txt内容如下：

![img](https://pic2.zhimg.com/80/v2-d44c0a29d5a1c30e3d57b6e135812005_720w.webp)



现在我们可以把dev分支上的内容合并到分支master上了，可以在master分支上，使用如下命令 git merge dev 如下所示：

![img](https://pic3.zhimg.com/80/v2-45cad75cce9215d6fee3b8cefabfda86_720w.webp)
...
![img](https://pic4.zhimg.com/80/v2-20cd58923dc935f89f1de193a4a792c7_720w.webp)
...
![img](https://raw.githubusercontent.com/nieyuli98/clouding/master/img/v2-a87639c3d8c403ecc7a57129a95f62bd_720w.webp)
...
相关标签：[Html/CSS](https://link.zhihu.com/?target=http%3A//www.imooc.com/article/tag/5)[JavaScript](https://link.zhihu.com/?target=http%3A//www.imooc.com/article/tag/17)[前端工具](https://link.zhihu.com/?target=http%3A//www.imooc.com/article/tag/26)



作者： 蘇小小

链接：[http://www.imooc.com/article/20411](https://link.zhihu.com/?target=http%3A//www.imooc.com/article/20411)
